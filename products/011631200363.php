...
<head>
  ...
  <title>011631200363 | Products</title>
...
<div>
  <h4>Cotton Craft - Jaipur Solid Wood Handcrafted Carved Folding Accent Coffee Table - Antique Brown - 18 Inch Round Top x 18 Inch High</h4>
  <div class="col-sm-6">
    <img src="/products/011631200363-IMG01.jpg" alt="Main Image" width="470" height="520">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our Antique design Folding Accent Coffee Table is hand carved from 100% sustainably harvested Mango wood. This attractive accent table will compliment an assortment of décors. Ideal construction to hold up to 50 pound with collapsible folding panels for easy storing. Wipe clean with dry cloth for easy care. MINOR ASSEMBLY REQUIRED.</p>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631200363</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>18x18 Inches</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Antique Brown</td>
      </tr>
      <tr>
        <th class="info">Packaging: </th><td>1 Pc</td>
      </tr>
      <tr>
        <th class="info">Material Type: </th><td>Mango Wood</td>
      </tr>
    </table>
    <legend>Authorization</legend>

    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00GOVGZBC">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
