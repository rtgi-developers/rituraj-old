...
<head>
  ...
  <title>011631608480 | Products</title>
...
<div>
  <h4>Cotton Craft - Beaded Table Runner - Trevi - Platinum - 13x36  - Hand Made by Skilled Artisans - A Beautiful Complement to Your Dinner Table Décor - Spot Clean Only</h4>
  <div class="col-sm-6">
    <img src="/products/011631608480-IMG01.jpg" alt="Main Image">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our hand beaded table runners are constructed in vibrant colors that bring a global flavor to your table décor. Each piece is as unique as the skilled artisan who has made it.</p>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631608480</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>13x36 Inches</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Grey</td>
      </tr>
      <tr>
        <th class="info">Packaging: </th><td>Open Stock</td>
      </tr>
      <tr>
        <th class="info">Material Type: </th><td>Beaded</td>
      </tr>
    </table>
    <legend>Authorization</legend>

    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00R64RSDA">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
