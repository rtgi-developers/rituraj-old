...
<head>
  ...
  <title>011631618045 | Products</title>
...
<div>
  <h4>Cotton Craft - 2 Pack - Jute Burlap Table Roll 12 Inches x 3 Yards Each - Total 6 Yards - Natural Burlap - Overlock Sewn Edges - Perfect for Home Décor, Projects, Weddings, Crafts and Much More</h4>
  <div class="col-sm-6">
    <img src="/products/011631618045-IMG01.jpg" alt="Main Image">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our Cotton Craft Jute Burlap table runner roll is crafted from 100% natural jute fibers. Perfectly adds a touch of style to your table yet versatile to decorate other furniture items in your home. Practice caution around open flames. Spot Clean Only. The runners are shipped tightly in roll.</p>
    <ul>
      <li>CONTENTS: Package contains Two Natural Color Jute Burlap Table Runners Rolls with overlocked and sewn edges</li>
      <li>SIZE: Each Table Runner Roll measures 12 inches wide and 3 Yards long (108 inches).</li>
      <li>HIGH QUALITY: Made from 100% Natural Jute Fibers. Tighter and no -gap weave makes it more durable material.</li>
      <li>VERSATILE: Ideal for Home Décor projects, weddings, Christmas, Thanksgiving, Tables, Dressers, Chests and much more</li>
      <li>CARE: Spot Clean Only. Practice caution around open flames.</li>
    </ul>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631618045</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>12 Inches Wide &amp; 3 Yards Long Each</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Natural</td>
      </tr>
      <tr>
        <th class="info">Packaging: </th><td>2 Pack Set</td>
      </tr>
      <tr>
        <th class="info">Material Type: </th><td>Jute Burlap</td>
      </tr>
    </table>
    <legend>Authorization</legend>

    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00QTQ57GQ">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
