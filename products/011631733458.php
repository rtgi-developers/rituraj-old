...
<head>
  ...
  <title>011631733458 | Products</title>
...
<div>
  <h4>Cotton Craft - Beach Towel for Two 58x68 - Summer Of Siam Multi Stripe - Beach Blanket - 100% Pure Ringspun Cotton - 450 GSM - Oversized Jacquard Woven Velour Beach Towel - Thick Luxurious Velour Pile</h4>
  <div class="col-sm-6">
    <img src="/products/011631733458-IMG01.jpg" height="400" alt="Main Image">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our Luxurious Velour Double Jacquard Woven Beach towels are perfect to use as a colorful bath towel, picnic blanket or a poolside towel. The towels are woven on state of the art European Double Jacquard Looms. Constructed from pure 100% ringspun cotton with a super soft, luxurious velour finish. High quality towels will last for a long time. Easy to care for just toss them in a washing machine.</p>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631733458</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>56x68 Inches</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Multi Color Stripe</td>
      </tr>
      <tr>
        <th class="info">Packaging: </th><td>Single Pack</td>
      </tr>
      <tr>
        <th class="info">Material Type: </th><td>Velour Double Jacquard</td>
      </tr>
    </table>
    <legend>Authorization</legend>

    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00JMDJK8O">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
