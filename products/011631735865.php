...
<head>
  ...
  <title>011631735865 | Products</title>
...
<div>
  <h4>Cotton Craft - 2 Pack Ultra Soft Oversized Extra Large Bath Sheet 35x70 Ivory - Weighs 33 Ounces - 100% Pure Ringspun Cotton - Luxurious Rayon trim - Ideal for everyday use - Easy care machine wash</h4>
  <div class="col-sm-6">
    <img src="/products/011631735865-IMG01.jpg" alt="Main Image">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our 100% pure ringspun cotton oversized and extra large bath sheets are woven on state of the art super luxury towel looms. These bath sheets are absorbent and very durable. Ideal for everyday use and can also be used as beach towels. We recommend to launder before first use. They will grow softer and fluffier with each wash. Avoid skin care product and bleaching detergents as this may cause towel discoloration.</p>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631735865</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>35x70 Inches</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Ivory</td>
      </tr>
      <tr>
    ...
    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00LIU94EE">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
