...
<head>
  ...
  <title>011631736527 | Products</title>
...
<div>
  <h4>Cotton Craft Ultra Soft 12 Pack Wash Cloths 12x12 Ivory weighs 2 Ounces each - 100% Pure Ringspun Cotton - Luxurious Rayon trim - Ideal for everyday use - Easy care machine wash</h4>
  <div class="col-sm-6">
    <img src="/products/011631736527-IMG01.jpg" alt="Main Image" height="300" width="500">
  </div>
  <div class="col-sm-6">
    <legend>Product Description</legend>
    <p>Our 100% pure ringspun cotton wash cloths and dish cloths are woven on state of the art super luxury towel looms. These wash cloths are highly absorbent and will last a long time. Ideal for everyday use, these are highly versatile and can also be used as dish cloths. We recommend to launder before first use. Easy to care for, just throw them in your washing machine. They will grow softer and fluffier with each wash.</p>
    <legend>Product Details</legend>
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631736527</td>
      </tr>
      <tr>
        <th class="info">Size: </th><td>12x12 Inches</td>
      </tr>
      <tr>
        <th class="info">Color: </th><td>Ivory</td>
      </tr>
      <tr>
        <th class="info">Packaging: </th><td>12 Pack Set</td>
      </tr>
      <tr>
    ...
    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00X17SHVS">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
