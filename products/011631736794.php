...
<head>
  ...
  <title>011631736794 | Products</title>
...
<div>
  <h4>Cotton Craft Ultra Soft 12 Pack Wash Cloths 12x12 Charcoal weighs 2 Ounces each - 100% Pure Ringspun Cotton - Luxurious Rayon trim - Ideal for everyday use - Easy care machine wash</h4>
  <div class="col-sm-6">
    <img src="/products/011631736794-IMG01.jpg" alt="Main Image">
  </div>
  <div class="col-sm-6">
    ...
    <table class="table table-condensed table-bordered small">
      <tr>
        <th class="info">UPC: </th><td class="text-primary">011631736794</td>
      </tr>
      <tr>
      ...
      <tr>
        <th class="info">Material Type: </th><td>Cotton</td>
      </tr>
    </table>
    <legend>Authorization</legend>

    <p class="text-mute">We have authorized <a href="">Orient Originals, Inc.</a> to sell this product under the brand name <a href="https://www.amazon.com/dp/B00X17TFAA">Cotton Craft</a> in any e-commerce websites.</p>
  </div>
</div>
